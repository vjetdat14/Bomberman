...
//import uet.oop.bomberman.entities.EnemiKillItem;
//import uet.oop.bomberman.entities.DetonatorItem;
//import uet.oop.bomberman.entities.RandomItem;
//import uet.oop.bomberman.entities.WallPassItem;
...
public class Map {
    public static void createMap() {
        ...
        try {
            scanner = new Scanner(new FileReader("res/levels/Level1.txt")); // đọc file txt chứa thông tin về lv map
...
//                        stillObjects.add(new DetonatorItem(j, i, Sprite.powerup_detonator.getFxImage(),nLayer));
                ...
                else if (r.charAt(j) == 'r') {
//                        stillObjects.add(new RandomItem(j, i, Sprite.powerup_random.getFxImage(), nLayer));
                        stillObjects.add(new Brick(j, i, Sprite.brick.getFxImage(), nLayer+1));
                    }
